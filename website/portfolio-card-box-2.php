                    ...
                    <div class="row grid">
                            ...
                            <div class="single-portfolio-card mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="assets/images/portfolio/equal/1.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="assets/images/portfolio/equal/2.jpg">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 grid-item cat5 cat2">
                            <div class="single-portfolio-card mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="assets/images/portfolio/equal/2.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 grid-item cat2 cat3">
                            <div class="single-portfolio-card mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="assets/images/portfolio/equal/3.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="video-popup" href="https://www.youtube.com/watch?v=cDDWvj_q-o8">
                                            <i class="zmdi zmdi-videocam"></i>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 grid-item cat5 cat2">
                            <div class="single-portfolio-card mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="assets/images/portfolio/equal/4.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="assets/images/portfolio/equal/2.jpg">
                                            <i class="zmdi zmdi-instagram"></i>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 grid-item cat2 cat5">
                            <div class="single-portfolio-card mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="assets/images/portfolio/equal/5.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="video-popup" href="https://www.youtube.com/watch?v=cDDWvj_q-o8">
                                            <i class="zmdi zmdi-videocam"></i>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 grid-item cat3 cat5">
                            <div class="single-portfolio-card mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="assets/images/portfolio/equal/6.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="assets/images/portfolio/equal/2.jpg">
                                            <i class="zmdi zmdi-instagram"></i>
